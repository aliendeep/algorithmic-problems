...
you travel to station 0 and still have 1 unit of gas left over. You 
fill in gas[0] = 1 unit of additional gas, making your current gas = 2. It costs 
you cost[0] = 2 to get to station 1, which you do and complete the circuit. 
*/
...
public class Solution {
    public int canCompleteCircuit(final List<Integer> gas, final List<Integer> cost) {
        ...
        for(int i=0; i<gas.size(); i++){
            ...
            if(sum < 0){
                sum = 0;
                // try with the station as the starting station
                start = i+1;
            }
        }
        if(total >= 0)
