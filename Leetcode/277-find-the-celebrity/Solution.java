...
"Hi, A. Do you know B?" to get information of whether A knows B. You need to find out the celebrity (or verify there is not one) 
...
// Reduce calls to knows function
public class Solution extends Relation {
    public int findCelebrity(int n) {
        ...
        // We don't need to check if candidate knows candidate+1 to n-1 in the second pass, because the first loop has already done that.
        // Second pass to check whether candidate is real
        for(int i=0; i<n; i++){
