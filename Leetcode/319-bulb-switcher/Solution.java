...
every i bulb. For the nth round, you only toggle the last bulb. Find how many 
...
public class Solution {
    // Only the perfect squares such as (1*1, 2*2, 3*3, 4*4, sqrt(n)*sqrt(n)) 
    // will remain on at the end of round n
