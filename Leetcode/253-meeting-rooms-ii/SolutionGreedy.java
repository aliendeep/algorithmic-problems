...
/* 
Greedy
Min Heap stores all concurrent conflicting meetings. Those kind of meetins need separate rooms. The front of the queue has the conflicting element that has the earliest end time. 
